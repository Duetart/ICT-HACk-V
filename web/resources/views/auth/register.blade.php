                ...
                <div class="card" style="background: #7B45EC;">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="name" class="col-md-4 col-form-label text-md-end">Фамилия имя</label>
                            ...
                            <div class="row mb-3">
                                <label for="password-confirm"
                                       class="col-md-4 col-form-label text-md-end">Повторение пароля</label>
                            ...
                            <div class="row mb-3">
                                <label for="account_type" class="col-md-4 col-form-label text-md-end">Зарегистрироваться
                                    как</label>
                                <div class="col-md-6">
